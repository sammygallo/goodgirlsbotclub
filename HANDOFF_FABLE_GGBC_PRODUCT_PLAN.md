...
> **SUPERSEDED (2026-08-24) by `docs/product-roadmap-10.2-12.md` — that file is the planning source of truth.**
> **Stale-status corrections applied 2026-08-28** (this untracked file missed the 2026-08-26 tracked-carrier sweep; roadmap §1 records the gap):
...
- **Status (corrected 2026-08-28):** SHIPPED ~May 2026 — editor, CRUD, import/export, gallery all live; nothing remaining
...
- **Status (corrected 2026-08-28):** SHIPPED — PR #58 merged April 2026. Nothing in flight, nothing to merge.
- **Details:** Frontend UX polish (5 preset buttons, test connection, model-list auto-fetch, CORS-aware help) — all live
- ~~**Recommendation:** Complete + merge before Phase 10.2 begins~~ (obsolete: it shipped four months before this doc was written)
...
- **Phase C (corrected 2026-08-28):** ~~pending~~ — Studio C1 (training) + C2 (serve) + Phase 3 content-bound provenance all MERGED + DEPLOYED 2026-08-23 (#75/#436). Residual: the Replicate-alt backend piece only
...
- **Status (corrected 2026-08-28):** SHIPPED 2026-04-11 in PR #59 (`GroupChatInfo.cardMode`, swap/join builder branches, segmented picker) — the original rows here were false when written
...
- **Action (corrected 2026-08-28): DONE — audit delivered 2026-08-24 as `docs/prompt-injection-audit.md` (E2-S1, PR #449).** All four open questions above are answered there (no dedup exists — proven empirically; two activation engines; recall is pre-history; group has a WI budget but no history trim); its §8 taxonomy became E2-S2's spec, and E2-S2 shipped the user-visibility half on 2026-08-28. Seven findings filed as #450–#456. Do not re-commission this audit.
...
- ~~Phase 10.1: Local model support (in flight; PR #58)~~ — SHIPPED April 2026 (corrected 2026-08-28)
...
- ~~**Phase 10.1 completion** gates Phase 10.2~~ — VOID (corrected 2026-08-28): 10.1 shipped April 2026, so it gates nothing
...
1. ~~**Phase 10.1 completion** (Local Models) → unblocks Phase 10.2~~ — VOID, already shipped (corrected 2026-08-28)
...
- ~~**Phase 10.1 (Weeks 1–2, Pre-existing):**~~ — VOID (corrected 2026-08-28)
  - ~~`[CLEANUP]` Complete PR #58 (local models) + merge to main~~ — DO NOT ACT: #58 merged April 2026
...
- `project_roadmap_status.md` — **NOT authoritative** (corrected 2026-08-28): its own header records six status rows proved wrong; it produced the E9-S1/E9-S3/E9-S4 dead-work incidents. Ground-truth against `git`/`gh` instead
