...
// Lens stance mirrors .claude/agents/adversarial-reviewer.md (its ## Stance and
// ## Never sections) — kept inline so this script runs even in sessions where
// custom agent types are not loaded. Change one, change both: the postmortem agent
// diffs the pair at CURATE, and E9-S7's found two bullets missing here.
