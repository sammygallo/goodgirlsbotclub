...
| **Ready for Dev** | E2-S2 (token breakdown — S1 delivered, spec = audit §8; measure at assembly, per E2-S1's fork resolution) · E2-S2a (activation reason in the server DTO — content-neutral, parallelizable) · E9-S7 (recall `no_key`, #455) · E9-S9 (group recall identity, #458) |
