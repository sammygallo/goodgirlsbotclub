...
| Column | Cards |
|---|---|
| **In Review** | **E2-S2a** activation reason in the server DTO — backend [#82](https://github.com/sammygallo/ggbc-backend/pull/82) + frontend [#490](https://github.com/sammygallo/goodgirlsbotclub/pull/490), opened 2026-08-29; 3 adversarial rounds converged at zero confirmed, QA 4/4 AC mutation-verified; **at the merge gate on the cross-repo-contract trigger** |
