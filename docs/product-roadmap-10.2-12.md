...
| Claim-set / design red-team | the deliverable IS a claim set: audits, pre-code red-teams, process-rule changes (§5's L-minimum rule) | 1–2 claim-set passes | ~3.4–9.5M (rounds × the claim-set unit) | E2-S1 audit: ~5.1M (1) · charter v1.2 red-team: ~9.1M (2 — the §4.4 calibration datum, 4.55M/pass) · E2-S2's D/E/F red-team: ~3.4M (1) · this recalibration's own: ~4.6M (1) |
...
| Token spend drifts above bands | **Realized, then repriced** | Per-run actuals reported (§6.5); bands recalibrated 2026-08-28 with verification moved to a rounds×unit model (§5) after four of six runs blew letter-priced verify bands (worst on record, derived: E9-S6 ~61× its S ceiling, E2-S2 ~24× its L ceiling; E1-S1 landed in band, E9-S1 blocked pre-review); next recalibration at the Arch v2 GO gate; XL work (E8-S4) sits behind the gate where the bet is already validated. |
