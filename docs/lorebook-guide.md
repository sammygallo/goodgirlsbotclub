...
- **Trailing** (@ Depth 0–1): the one non-negotiable rule of the scene. Depth 0 lands the card right after the newest message, with the post-history sections (post-history instructions and `after_an` cards) coming after it — the spot it obeys most.
